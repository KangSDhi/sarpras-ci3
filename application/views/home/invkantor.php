			...
			<div class="top-row">
				<div class="col-xs-4">
					<div class="top-row-col1 text-center">
						<h2><b>KANTOR</b></h2>
						<img class="r-img text-center" src="<?php echo base_url();  ?>assets/img/gedung.png" title="name" /><a href="<?php echo base_url('inv/data/9');  ?>" />
						<span></span>
						<h4><b>TATA USAHA</b></h4></a>
				...
				<div class="col-xs-4">
					<div class="top-row-col1 text-center">
						<h2><b>KANTOR</b></h2>
						<img class="r-img text-center" src="<?php echo base_url();  ?>assets/img/gedung.png" title="name" /><a href="<?php echo base_url('inv/data/10');  ?>" />
						<span></span>
						<h4><b>GURU</b></h4></a>
				...
				<div class="col-xs-4">
					<div class="top-row-col1 text-center">
						<h2><b>KANTOR</b></h2>
						<img class="r-img text-center" src="<?php echo base_url();  ?>assets/img/gedung.png" title="name" /><a href="<?php echo base_url('inv/data/11');  ?>" />
						<span></span>
						<h4><b>KEPALA SEKOLAH</b></h4></a>
