			...
			<div class="top-row">
				<div class="col-xs-4">
					<div class="top-row-col1 text-center">
						<h2><b>KELAS</b></h2>
						<img class="r-img text-center" src="<?php echo base_url();  ?>assets/img/gedung.png" title="name" /><a href="<?php echo base_url('invkelas/tkj');?>" />
						<span></span>
						<h4><b>Teknik Komputer Dan Jaringan</b></h4></a>
				...
				<div class="col-xs-4">
					<div class="top-row-col1 text-center">
						<h2><b>KELAS</b></h2>
						<img class="r-img text-center" src="<?php echo base_url();  ?>assets/img/gedung.png" title="name" /><a href="<?php echo base_url('invkelas/tkr');?>" />
						<span></span>
						<h4><b>Teknik Kendaraan Ringan Dan Otomotif</b></h4></a>
