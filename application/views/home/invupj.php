			...
			<div class="top-row">
				<div class="col-xs-4">
					<div class="top-row-col1 text-center">
						<h2><b>UPJ</b></h2>
						<img class="r-img text-center" src="<?php echo base_url();  ?>assets/img/gedung.png" title="name" /><a href="<?php echo base_url('inv/data/7');  ?>" />
						<span></span>
						<h4><b>UNIT PELAYANAN JASA TKJ</b></h4></a>
				...
				<div class="col-xs-4">
					<div class="top-row-col1 text-center">
						<h2><b>UPJ</b></h2>
						<img class="r-img text-center" src="<?php echo base_url();  ?>assets/img/gedung.png" title="name" /><a href="<?php echo base_url('inv/data/8');  ?>" />
						<span></span>
						<h4><b>UNIT PELAYANAN JASA TKR</b></h4></a>
