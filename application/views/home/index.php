	...
	<body>
		...
		<div class="container">
			...
			<div class="top-header">
				<div class="logo">
					<a href="<?php echo base_url();  ?>index.php/welcome"><H2><B> INVENTARISASI BARANG SMK SABILUL MUTTAQIN MARGOAGUNG</B></H2></a>
				</div>
				...
				<div class="special-products">
					<div class="s-products-head">
						<div class="s-products-head-left">
							<h1><center><span><b>SELAMAT DATANG DI LAYANAN INFORMASI TENTANG INVENTARISASI BARANG SMK SABILUL MUTTAQIN</b></span></center></h1>
						</div>
						
						<div class="clearfix"> </div>
					</div>
					<!----special-products-grids---->
					<!-- <th><center>UD.ANA JAYA menyediakan berbagai jenis Hewan sapi dan kambing. Untuk di jadikan Hewan Qurban yang sah baik dari segi kualitas maupun kuantitas.  </center></th> -->
					
						<div class="s-products-head-left">
							<h3><center><span><b> </b> </span></center></h3>
						</div>
						<div class="clearfix"> </div>
					</div>
					<!---//special-products-grids---->
			...
			<div class="footer">
				<div class="container">
					...
					<div class="col-md-7 footer-links">
						<ul class="unstyled-list list-inline">
							<li><a href="<?php echo base_url();  ?>index.php/tentangkami"> <h4><b>SMK SABILUL MUTTAQIN MARGOAGUNG</b></h4></a> </li>
