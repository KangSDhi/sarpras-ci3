            ...
            <div class="container-fluid">
                ...
                <div class="row-fluid">
                    <div class="span12">
                        ...
                        <h3 class="page-title">
                            <b>Form Pengeditan Data Barang <?php echo $data_ruang->nama_ruang; ?></b>
                        </h3>
                        <ul class="breadcrumb">
                            <li>
                                <a href="#">Home</a>
                            ...
                            <li class="active">
                                Form Pengeditan Data Barang <?php echo $data_ruang->nama_ruang; ?>
                            </li>
                    ...
                    <div class="span12">
                        ...
                        <div class="widget green">
                            ...
                            <div class="widget-body">
                                <!-- BEGIN FORM-->
                                <form action="<?php echo base_url('ruangan/barang/update') ?>" class="form-horizontal" method="POST">
                                    <input type="hidden" name="id_ruang" value="<?php echo $data_barang->ruang_id ?>">
									<input type="hidden" name="id_barang" value="<?php echo $data_barang->id ?>">
                                    <div class="control-group">
                                        <label class="control-label">Nama Barang</label>
                                        <div class="controls">
                                            <input name="nama_barang" type="text" class="input-xlarge" value="<?php echo $data_barang->nama_barang ?>" />
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label">Kode Inventaris</label>
                                        <div class="controls">
                                            <input name="kode_inventaris" type="text" class="input-xlarge" value="<?php echo $data_barang->kode_inventaris ?>" />
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label">Bahan</label>
                                        <div class="controls">
                                            <input name="bahan" type="text" class="input-xlarge" value="<?php echo $data_barang->bahan ?>" />
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label">Tahun Pembelian</label>
                                        <div class="controls">
                                            <input name="tahun_pembelian" type="text" class="input-xlarge" value="<?php echo $data_barang->tahun_pembelian ?>" />
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label">Jumlah</label>
                                        <div class="controls">
                                            <input name="jumlah" type="number" class="input-xlarge" value="<?php echo $data_barang->jumlah ?>" />
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label">Rusak</label>
                                        <div class="controls">
                                            <input name="rusak" type="number" class="input-xlarge" value="<?php echo $data_barang->rusak ?>" />
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label">Status</label>
                                        <div class="controls">
                                            <input name="status" type="text" class="input-xlarge" value="<?php echo $data_barang->status ?>" />
                                        </div>
                                    </div>
