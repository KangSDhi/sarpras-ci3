                    ...
                    <div class="span12">
                        ...
                        <div class="widget green">
                            <div class="widget-title">
                                <h4><i class="icon-reorder"></i> Form Edit Data Ruangan </h4>
                            </div>
                            <div class="widget-body">
                                <!-- BEGIN FORM-->
                                <form action="<?php echo base_url('ruangan/update'); ?>" method="POST">
                                <input type="hidden" value="<?php echo $data_ruang->id ?>" name="id">
                                <div class="control-group">
                                    <label class="control-label">Nama Kategori</label>
                                    <div class="controls">
                                        <input name="ruangan" type="text" class="span6 " value="<?php echo $data_ruang->nama_ruang ?>" />
                                    </div>
                                </div>
